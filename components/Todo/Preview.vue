...
<template>
  ...
  <div class="space-y-6">
    ...
    <div>
      ...
      <h1 class="text-md font-bold text-gray-900 dark:text-white mb-2 leading-tight">
        {{ todo.title }}
      </h1>
    ...
    <div>
      ...
      <div class="bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 p-3 rounded-md">
    ...
    <div>      
      <div class="flex flex-col md:flex-row md:justify-between gap-2">
        <div>
          ...
          <div v-if="todo.due_date" class="text-sm font-semibold text-gray-900 dark:text-white">
            {{ dayjs(todo.due_date).format('DD MMMM YYYY') || 'Belum ada deadline' }}
          </div>          
          <div v-if="todo.due_date && todo.due_date_days_left !== undefined">
