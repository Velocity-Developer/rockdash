<template>
  <div class="space-y-4">
    ...
    <!-- Dialog for Add/Edit -->
    <Dialog v-model:visible="visibleDialog" :dismissableMask="true" modal :header="actionDialog=='add'?'Tambah Project':'Edit Project'" :style="{ width: '50rem' }" :breakpoints="{ '1199px': '75vw', '575px': '90vw' }">
