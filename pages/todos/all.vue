        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 dark:text-gray-400 mt-1">
                    Daftar semua todo yang ada di sistem
                </p>
            </div>
                ...
                <template #content>
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900 dark:text-white">
                                {{ statistics?.created_completed || 0 }}
                            </p>
                        </div>
                    </div>
                </template>
            ...
            <Card v-else class="space-y-3">
                <template #content>
                    ...
                    >
                        ...
                        <Column field="creator" header="Pembuat">
                            <template #body="slotProps">
                                <div
...
definePageMeta({
    title: "Semua Todo",
    description: "Kelola semua tugas dalam sistem",
});
...
// Initialize
onMounted(async () => {
    await Promise.all([getCategories(), loadTodos(), getStatistics()]);
});
</script>